...
const file_name_lgd = process.argv[4];
...
async function runCommands() {
  ...
  try {
    ...
    if (selectedLgdFile) {
        ...
        await writeToDebugLog(debug_file, `cmd : join_logo_scp -inlogo "/home/pi/CmcutScp/result/${file_name}/logoframe_inlogo.txt.txt" -inscp "${inscp_pas}" -incmd "/home/pi/CmcutScp/join_logo_scp_trial/JL/JL_標準.txt" -o "/home/pi/CmcutScp/result/${file_name}/join_logo_scp.txt"\n`);
