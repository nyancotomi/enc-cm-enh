...
input_file="/home/pi/CmcutScp/result/$file_input/join_logo_scp.csv"
...
# カット情報ファイルが保存されるディレクトリ
result_dir="/home/pi/CmcutScp/result/$file_input" #ts_file_name
...
csv_file="/home/pi/CmcutScp/result/$file_input/cm_subtitle_jls.csv"
debug_file="/home/pi/CmcutScp/result/$file_input/debug_file.log"
subtitle_file="/srv/dev-disk-by-uuid-A6DA96A3DA966F75/NAS/Recorded/subtitle/$file_input.jpn.srt"

echo -e "subtitle_file:$subtitle_file, \n ts_file_name:$ts_file_name, \n ts_file_input:$ts_file_input, \n"file_inpu:$file_input", \noutput_file:$output_file, \n input_file:$input_file, \n$csv_file " >> "$debug_file"

# input_fileの1列目の1行目の値を確認する
#first_value=$(head -n 1 "$input_file" | cut -d',' -f1)

#if [ "$first_value" -eq 0 ]; then
#  echo "1列目の1行目の値が0のため、スクリプトを中止します。" >> "$debug_file"
#  exit 1
#fi
