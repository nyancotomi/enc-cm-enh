...
async function generateFilterComplex(joinOutputFile) {
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        const line_sta_exe = `/home/pi/EPGStation/config/run.sh encod_sta "${data}"`;
...
async function runCommands() {
  ...
  try {
    ...
    const logoFolder = '/home/pi/JoinLogoScpTrialSetLinux/modules/join_logo_scp_trial/logo/';
    ...
    if (selectedLgdFile) {
        ...
        const join_logo_scp = `join_logo_scp -inlogo "/home/pi/CmcutScp/result/${file_name}/logoframe_inlogo.txt" -inscp "${inscp_pas}" -incmd "/home/pi/JoinLogoScpTrialSetLinux/modules/join_logo_scp_trial/JL/JL_標準.txt" -o "/home/pi/CmcutScp/result/${file_name}/join_logo_scp.txt"`;
        await writeToDebugLog(debug_file, `cmd : join_logo_scp -inlogo "/home/pi/CmcutScp/result/${file_name}/logoframe_inlogo.txt.txt" -inscp "${inscp_pas}" -incmd "/home/pi/JoinLogoScpTrialSetLinux/modules/join_logo_scp_trial/JL/JL_標準.txt" -o "/home/pi/CmcutScp/result/${file_name}/join_logo_scp.txt"\n`);
    ...
    Array.prototype.push.apply(args, ['-b:v', '2M']);
