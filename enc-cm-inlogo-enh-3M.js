...
async function runCommands() {
  ...
  try {
    ...
    avs_script += `AudioDub(last, LWLibavAudioSource(TSFilePath, av_sync=true, layout="FL+FR+FC+LFE+BL+BR"))`;
    // AVSスクリプトをファイルに書き込む
    ...
    if (selectedLgdFile) {
        ...
        const join_logo_scp = `join_logo_scp -inlogo "/home/pi/CmcutScp/result/${file_name}/logoframe_inlogo.txt" -inscp "${inscp_pas}" -incmd "/home/pi/CmcutScp/join_logo_scp_trial/JL/JL_フラグ指定.txt" -o "/home/pi/CmcutScp/result/${file_name}/join_logo_scp.txt"`;
        await writeToDebugLog(debug_file, `cmd : join_logo_scp -inlogo "/home/pi/CmcutScp/result/${file_name}/logoframe_inlogo.txt.txt" -inscp "${inscp_pas}" -incmd "/home/pi/CmcutScp/join_logo_scp_trial/JL/JL_フラグ指定.txt" -o "/home/pi/CmcutScp/result/${file_name}/join_logo_scp.txt"\n`);
    ...
    Array.prototype.push.apply(args, ['-b:v', '3M']);
