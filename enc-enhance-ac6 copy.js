...
//const cutTime = 35; // カットする秒数

// input 設定
//Array.prototype.push.apply(args, ['-ss', cutTime]);
...
//Array.prototype.push.apply(args, ['-vf', 'yadif,scale=-2:1080 ']);
...
//Array.prototype.push.apply(args, ['-vf', 'bwdif=1']);
