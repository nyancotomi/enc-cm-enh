...
const file_path_o = process.env.INPUT_O;
...
const debug_file = `/home/pi/CmcutScp/result/${file_name}/join_debug_0000.log`;
let debug_script = '';
...
async function runCommands() {
  ...
  try {
    ...
    await writeToDebugLog(debug_file, "↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓\n");
    await writeToDebugLog(debug_file, "/home/pi/EPGStation/config/enc-cm-enh-0000.jsで追記\nAVSスクリプトファイルを生成完了\n");
